AFRAME.registerComponent('block', {
	...
	init: function(){
		...
		function positionPlot(plot, lastPlot, ring, ringIndex){
			...
			switch(ring){
				...
				case 10:
					switch(ringIndex){
						...
						case 12:
							...
							break;
						case 13:
							x 			= ((topWidth*10) - (wingWidth/2))
							y 			= -((height*(ring-10)) + (height/2));
							rotation 	= angleRot;
							break;
						case 14:
							x 			= ((topWidth*10) - (wingWidth/2))
				...
				case 11:
					switch(ringIndex){
						...
						case 13:
							x 			= ((topWidth*10) - (wingWidth/2))
							y 			= -((height*(ring-8)) - (height/2));
							rotation 	= angleRot;
							break;
						case 14:
							x 			= ((topWidth*11) - wingWidth)
							y 			= -(height*(ring-10));
							pivot 		= "bottom";
							rotation 	= -angleRot/2;
							break;
						...
						case 17:
							y 			= (height*(ring-8));
							x 			= ((topWidth*9) + wingWidth)
							pivot 		= "bottom";
							rotation 	= -angleRot;
							break;
						case 18:
							x 			= ((topWidth*9) - (wingWidth/2))
							y 			= ((height*(ring-7)) + (height/2));
							rotation 	= angleRot/2;
							break;
						case 19:
			...
			if(ring == 11) 	AFRAME.utils.entity.setComponentProperty(plot, "material.color", "#222")
